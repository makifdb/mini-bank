...
func (h *AccountHandler) CreateAccount(c *fiber.Ctx) error {
	...
	acc, err := h.accountService.CreateAccount(c.Context(), req.UserID, models.CurrencyCode(req.Currency), req.Amount)
	if err != nil {
...
func (h *AccountHandler) UpdateAccount(c *fiber.Ctx) error {
	...
	acc, err := h.accountService.UpdateAccount(c.Context(), id, models.CurrencyCode(req.Currency), req.Balance)
	if err != nil {
		return c.Status(http.StatusInternalServerError).JSON(fiber.Map{"error": err.Error()})
	}
