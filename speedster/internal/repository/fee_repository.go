...
func (r *FeeRepository) FindByID(ctx context.Context, id string) (*models.Fee, error) {
...
func (r *FeeRepository) CalculateFee(ctx context.Context, feeType models.FeeType, currency models.CurrencyCode, amount *utils.BigDecimal) (*utils.BigDecimal, error) {
